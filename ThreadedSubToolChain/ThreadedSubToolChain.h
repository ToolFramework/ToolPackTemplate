...
/**
 * \struct ThreadedSubToolChain_args
 *
...
struct ThreadedSubToolChain_args:Thread_args{

  ThreadedSubToolChain_args();
  ~ThreadedSubToolChain_args();
  bool busy;
...
class ThreadedSubToolChain: public Tool {
 ...
 public:
  ...
  ThreadedSubToolChain(); ///< Simple constructor
 ...
 private:
  ...
  std::vector<ThreadedSubToolChain_args*> args; ///< Vector of thread args (also holds pointers to the threads)
